...
<body>
    ...
    <div>
        ...
        <asp:RadioButton ID="rbServiceSatisfied" runat="server" Checked="True" GroupName="Service" Text="Satisfied" />
        <asp:RadioButton ID="rbServiceNeither" runat="server" GroupName="Service" Text="Neither Satisfied Nor Dissatisfied" />
        <asp:RadioButton ID="rbServiceDissatisfied" runat="server" GroupName="Service" Text="Dissatisfied" />
        <p>
            <asp:Label ID="lblTechEfficiency" runat="server" Text="Technical efficiency:" CssClass="label"></asp:Label>
            <asp:RadioButton ID="rbTechSatisfied" runat="server" Checked="True" GroupName="Tech" Text="Satisfied" />
            <asp:RadioButton ID="rbTechNeither" runat="server" GroupName="Tech" Text="Neither Satisfied Nor Dissatisfied" />
            <asp:RadioButton ID="rbTechDissatisfied" runat="server" GroupName="Tech" Text="Dissatisfied" />
        </p>
        <p>
            <asp:Label ID="txtProbResolution" runat="server" Text="Problem resolution:" CssClass="label"></asp:Label>
            <asp:RadioButton ID="rbProbSatisfied" runat="server" Checked="True" GroupName="Problem" Text="Satisfied" />
            <asp:RadioButton ID="rbProbNeither" runat="server" GroupName="Problem" Text="Neither Satisfied Nor Dissatisfied" />
            <asp:RadioButton ID="rbProbDissatisfied" runat="server" GroupName="Problem" Text="Dissatisfied" />
        </p>
        ...
        <p>
            ...
            <asp:CheckBox ID="cbContacted" runat="server" />
        </p>
        <asp:Label ID="Label1" runat="server" Text="Contact Method:" CssClass="label"></asp:Label>
        <asp:RadioButton ID="rb" runat="server" Text="Email" Checked="True" GroupName="Contact" />
        <asp:RadioButton ID="rbPhone" runat="server" GroupName="Contact" Text="Telephone" />
        <p>
