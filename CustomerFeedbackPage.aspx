...
<body>
    ...
    <div>
        ...
        <p>
            <asp:Button ID="btnSubmitFeedback" runat="server" Enabled="False" OnClick="btnSubmitFeedback_Click" Text="Submit Feedback" ValidationGroup="Feedback" CssClass="button" />
        </p>
    </form>
</body>
</html>
